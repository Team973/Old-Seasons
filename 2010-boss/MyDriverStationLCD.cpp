...
MyDriverStationLCD* MyDriverStationLCD::m_instance = NULL;

const INT32 MyDriverStationLCD::kLineLength = 21;

/**
 * MyDriverStationLCD contructor.
 * 
 * This is only called once the first time GetInstance() is called
 */
MyDriverStationLCD::MyDriverStationLCD()
	: m_textBuffer (NULL)
 ...
 */
MyDriverStationLCD* MyDriverStationLCD::GetInstance()
{
	if (m_instance == NULL)
	{
		m_instance = new MyDriverStationLCD();
	}
	return m_instance;
}
 ...
 */
void MyDriverStationLCD::UpdateLCD()
{
 ...
 */
void MyDriverStationLCD::Printf(Line line, INT32 startingColumn, const char *writeFmt, ...)
{
	va_list args;
 ...
 * @param writeFmt The printf format string describing how to print.
 */
void MyDriverStationLCD::PrintfLine(Line line, const char *writeFmt, ...)
{
	va_list args;
	char lineBuffer[kLineLength + 1];
