...
void AutoManager::setModes() {
    ...
    modes["ThreeTote"]->addConcurrent(new IntakeCommand(stateManager, -1.0, false, false, 0));
    ...
    modes["ThreeTote"]->addConcurrent(new IntakeCommand(stateManager, -1.0, false, true, 0));
    ...
    modes["ThreeTote"]->addSequential(new IntakeCommand(stateManager, 0.0, true, false, 0));
    ...
    modes["Test"]->addConcurrent(new IntakeCommand(stateManager, 1.0, false, false, .2));
    modes["Test"]->addSequential(new WaitCommand(0.0));// dummy
    modes["Test"]->addConcurrent(new TurnCommand(stateManager, 20, 3));
    modes["Test"]->addConcurrent(new IntakeCommand(stateManager, 1.0, true, false, .5));
