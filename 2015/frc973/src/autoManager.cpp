...
void AutoManager::setModes() {
    ...
    modes["ThreeTote"]->addSequential(new SauropodCommand(stateManager, "stow", 0, 1));
    modes["ThreeTote"]->addSequential(new DriveCommand(stateManager, twoTote - openOffset, true));
